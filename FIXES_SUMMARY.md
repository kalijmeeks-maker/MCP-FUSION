...
- If venv is missing, the debug launch now fails *loudly and helpfully* before attempting to run.
...
1. **Pre-launch validation** — Catch env issues *before* launching, not mid-execution.
